...
class ArchivesGallery extends ImmutablePureComponent {
  ...
  render () {
    ...
    return (
      <Column>
        ...
        <ScrollContainer scrollKey='archives_gallery' shouldUpdateScroll={shouldUpdateScroll}>
          <div className='scrollable scrollable--flex' onScroll={this.handleScroll}>
            <HeaderContainer accountId={this.props.params.accountId} />

            <div role='feed' className='archives-gallery__container' ref={this.handleRef}>
